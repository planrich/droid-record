...
class RecordGenerator {
    ...
    void generate(String source, String pkg) {
        ...
        c.wrap("public class Abstract${Inflector.camelize(table.name)}") {
            ...
            def fieldNames = table.getOrderedFields(true).collect() { f -> "m${f.javaName}" };

            c.line("private Object[] _fieldArray = { ${fieldNames.join(", ")} };")
            ...
            c.wrap("public Object[] dataFields()") {
                c.line("return _fieldArray;")
            }
